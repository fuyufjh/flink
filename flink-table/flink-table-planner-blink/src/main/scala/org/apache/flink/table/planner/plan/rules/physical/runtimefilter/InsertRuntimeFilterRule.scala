...
import org.apache.flink.table.planner.plan.rules.physical.runtimefilter.InsertRuntimeFilterRule._
...
import org.apache.flink.table.planner.plan.nodes.physical.batch.{BatchExecCalc, BatchExecExchange, BatchExecHashJoin}
import org.apache.flink.table.planner.plan.utils.FlinkRelOptUtil
import org.apache.flink.table.runtime.operators.join.FlinkJoinType._
...
class InsertRuntimeFilterRule
    extends RelOptRule(
      operand(classOf[BatchExecHashJoin], operand(classOf[RelNode], any)),
      "InsertRuntimeFilterRule") {

  override def matches(call: RelOptRuleCall): Boolean = {
    val join: BatchExecHashJoin = call.rel(0)
