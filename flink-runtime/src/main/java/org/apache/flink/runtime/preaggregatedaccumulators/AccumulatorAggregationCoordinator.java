...
public class AccumulatorAggregationCoordinator {
	...
	public void commitPreAggregatedAccumulator(AccessExecutionGraph executionGraph, CommitAccumulator commitAccumulator) {
		AccessExecutionJobVertex jobVertex = executionGraph.getJobVertex(commitAccumulator.getJobVertexId());
